...
var UserServiceLevelController = &userServiceLevelController{}

type userServiceLevelController struct {
}

func (c *userServiceLevelController) Add(ctx *fiber.Ctx) error {
	...
	duplicated, success, err := service.UserServiceLevelService.Add(instance)
	if err != nil {
		return ctx.JSON(&CommonResponse{
...
func (c *userServiceLevelController) Update(ctx *fiber.Ctx) error {
	instance := new(model.UserServiceLevel)
	if err := ctx.BodyParser(instance); err != nil {
		return ctx.JSON(&CommonResponse{
			Code: ResponseCodeParamParseError,
	...
	duplicated, success, err := service.UserServiceLevelService.Update(instance)
	if err != nil {
		return ctx.JSON(&CommonResponse{
			Code: ResponseCodeDatabase,
			Msg:  ResponseMsgDatabase + err.Error(),
...
func (c *userServiceLevelController) Delete(ctx *fiber.Ctx) error {
	idStr := ctx.Params("id")
	if idStr == "" {
		return ctx.JSON(&CommonResponse{
	...
	success, err := service.UserServiceLevelService.Delete(id)
	if err != nil {
		return ctx.JSON(&CommonResponse{
			Code: ResponseCodeDatabase,
			Msg:  ResponseMsgDatabase + err.Error(),
...
func (c *userServiceLevelController) Get(ctx *fiber.Ctx) error {
	idStr := ctx.Params("id")
	if idStr == "" {
		return ctx.JSON(&CommonResponse{
			Code: ResponseCodeParamNotEnough,
	...
	instance, err := service.UserServiceLevelService.Get(id)
	if err != nil {
		return ctx.JSON(&CommonResponse{
			Code: ResponseCodeDatabase,
			Msg:  ResponseMsgDatabase + err.Error(),
...
func (c *userServiceLevelController) List(ctx *fiber.Ctx) error {
	...
	instances, total, err := service.UserServiceLevelService.List(page, pageSize, condition)
	if err != nil {
		return ctx.JSON(&CommonResponse{
			Code: ResponseCodeDatabase,
			Msg:  ResponseMsgDatabase + err.Error(),
